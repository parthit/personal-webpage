...
![Three buckets of cubes flying everywhere on the left, and a quiet server ring on the right where only one short line of cubes moves.](/content/images/writing/consistent-hashing/modulo-vs-ring.jpg)
