...
[Consistent hashing](https://www.cs.princeton.edu/courses/archive/fall09/cos518/papers/chash.pdf) (Karger et al., 1997) hashes both the key and the node onto a ring. To place a key, walk clockwise until you hit a node. That node owns the arc just behind it: every key that reaches it before anyone else.
